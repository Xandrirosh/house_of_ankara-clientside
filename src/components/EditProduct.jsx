...
const EditProduct = ({ close, data: propsData, fetchProductData }) => {
    ...
    return (
        <section className='fixed top-0 left-0 w-full h-full bg-neutral-800 bg-opacity-70 z-50  p-4'>
            <div className='bg-white p-4 rounded  w-full max-w-2xl mx-auto overflow-y-auto h-full max-h-[95vh]'>
                <section>
